...
# Export UIDReader, Button, and VolumeControl as the correct class for the environment
if not IS_RASPBERRY_PI:
    # Use mock classes in non-Raspberry Pi environments
    UIDReader = MockUIDReader
    Button = MockButton
    VolumeControl = MockVolumeControl
else:
    # Use real classes on Raspberry Pi
    UIDReader = RealUIDReader
    Button = RealButton
    VolumeControl = RealVolumeControl
